...
enum class CarriageWayType : uint8_t
{
    ...
    Trunk    = 1, //!< Used for highway similar roads
    //!< (Germany: Autobahnaehnliche Strasse, umgangssprachlich: Schnellstraße)
...
{
    return (lhs.minLongitude == rhs.minLongitude) && (lhs.maxLongitude == rhs.maxLongitude)
           && (lhs.minLatitude == rhs.minLatitude) && (lhs.maxLatitude == rhs.maxLatitude);
}
