...
protected:
    ...
    //----------------------------------------
    bool processBuffer(const IbeoDataHeader*& dh, const char*& startOfMsgBody, const int nbOfBytesReceived);
...
protected:
    static constexpr const char* loggerId = "ibeo::common::sdk::MsgBufferBase";
