...
public:
    ...
    IBEOSDK_DEPRECATED static void transformToTangentialPlane(const double originsLatitudeInRad,
                                                              const double originsLongitudeInRad,
                                                              const double pointsLatitudeInRad,
                                                              const double pointsLongitudeInRad,
                                                              double& pointsX,
                                                              double& pointsY)
    {
        transformToTangentialPlane2d(
            originsLatitudeInRad, originsLongitudeInRad, pointsLatitudeInRad, pointsLongitudeInRad, pointsX, pointsY);
    }
...
public:
    ...
    IBEOSDK_DEPRECATED static void transformToTangentialPlane(const EcefPoint& originRefPointsEcef,
                                                              ...
                                                              double& pointsY)
    {
        transformToTangentialPlane2d(originRefPointsEcef, pointsLatitudeInRad, pointsLongitudeInRad, pointsX, pointsY);
    }
...
public:
    static void transformFromTangentialPlane2d(const double originsLattigudeInRad,
                                               const double originsLongitudeInRad,
    ...
    IBEOSDK_DEPRECATED static void transformFromTangentialPlane(const double originsLattigudeInRad,
                                                                const double originsLongitudeInRad,
                                                                const double pointsX,
                                                                const double pointsY,
                                                                double& pointsLatInRad,
                                                                double& pointsLonInRad)
    {
        transformFromTangentialPlane2d(
            originsLattigudeInRad, originsLongitudeInRad, pointsX, pointsY, pointsLatInRad, pointsLonInRad);
    }

public:
    static void transformFromTangentialPlane3d(const double originsLattigudeInRad,
                                               const double originsLongitudeInRad,
...
public: // setter
    ...
    {
        m_courseAngle = ibeo::common::sdk::normalizeRadians(val);
    ...
    {
        m_yawAngle = ibeo::common::sdk::normalizeRadians(val);
        if (m_yawAngle <= 0.0)
        {
            m_yawAngle += twoPi;
        }
...
public:
    void transformToTangentialPlane2d(const double originLattigudeInRad,
                                      const double originLongitudeInRad,
                                      double& pdX,
                                      double& pdY) const;

    IBEOSDK_DEPRECATED void transformToTangentialPlane(const double originLattigudeInRad,
                                                       const double originLongitudeInRad,
                                                       double& pdX,
                                                       double& pdY) const
    {
...
public:
    ...
    IBEOSDK_DEPRECATED void
    transformToTangentialPlaneWithHeading(const PositionWgs84& origin, double& x, double& y) const
    {
...
public:
    ...
    IBEOSDK_DEPRECATED void
    transformFromTangentialPlaneWithHeading(const double x, const double y, const PositionWgs84& origin)
    {
