...
#include <ibeo/common/sdk/LaneType.hpp>
...
private:
    //========================================
    uint64_t m_id{0};
    uint16_t m_nationalId{0};

    CarriageWayType m_type{CarriageWayType::Unclassified};

    CarriageWaySegmentTemplatePtrMap m_cwSegmentsMap{};
