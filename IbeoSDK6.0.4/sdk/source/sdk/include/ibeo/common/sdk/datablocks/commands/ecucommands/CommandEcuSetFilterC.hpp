...
class CommandEcuSetFilterC : public EcuCommandC<CommandId::Id::CmdManagerSetFilter>
{
...
public:
    ...
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.command.commandecusetfilter"};
