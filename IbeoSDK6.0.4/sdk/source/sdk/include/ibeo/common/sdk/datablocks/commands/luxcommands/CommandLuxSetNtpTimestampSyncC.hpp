...
class CommandLuxSetNtpTimestampSyncC : public LuxCommandC<CommandId::Id::CmdLuxSetNTPTimestampSync>
{
...
public:
    ...
    constexpr static const char* const containerType{
        "ibeo.sdk.specialcontainer.command2010.commandluxsetntptimestampsync"};
