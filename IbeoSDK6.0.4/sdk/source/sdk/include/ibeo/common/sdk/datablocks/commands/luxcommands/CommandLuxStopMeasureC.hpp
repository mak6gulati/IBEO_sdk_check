...
class CommandLuxStopMeasureC : public LuxCommandC<CommandId::Id::CmdLuxStopMeasure>
{
...
public:
    ...
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.command2010.commandluxstopmeasure"};
