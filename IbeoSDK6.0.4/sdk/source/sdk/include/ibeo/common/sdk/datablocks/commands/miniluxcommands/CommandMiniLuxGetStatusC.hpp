...
class CommandMiniLuxGetStatusC : public MiniLuxCommandC<CommandId::Id::CmdLuxGetStatus>
{
...
public:
    ...
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.command2010.commandminiluxgetstatus"};
