...
class CommandMiniLuxResetC : public MiniLuxCommandC<CommandId::Id::CmdLuxReset>
{
...
public:
    ...
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.command2010.commandminiluxreset"};
