...
class CommandMiniLuxStartMeasureC : public MiniLuxCommandC<CommandId::Id::CmdLuxStartMeasure>
{
...
public:
    ...
    constexpr static const char* const containerType{
        "ibeo.sdk.specialcontainer.command2010.commandminiluxstartmeasure"};
