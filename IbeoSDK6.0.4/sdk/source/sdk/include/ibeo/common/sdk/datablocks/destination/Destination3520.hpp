...
//! this data type was generated with the interface to BestMile for fleet management in mind [https://developer.bestmile.com/v1/docs/performing-a-mission#section-mission-fields-overview], it's similar to Destination field
class Destination3520 : public SpecializedDataContainer
{
...
public:
    Destination3520();
    virtual ~Destination3520() = default;

public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.destination3520"};
