...
//! \brief GPS IMU
//!
//! Special data type: \ref ibeo::common::sdk::GpsImu9001
class GpsImu : public DataContainerBase
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.generalcontainer.gpsimu"};
...
public:
    ...
    //----------------------------------------
    double getGpsDilutionOfPrecisionZ() const { return m_delegate.getGpsDilutionOfPrecisionZ(); }
...
public:
    ...
    {
        m_delegate.setGpsDilutionOfPrecisionZ(gpsDilutionOfPrecisionZ);
    }
...
protected:
    GpsImu9001 m_delegate; // only possible specialization currently
}; // GpsImuContainer
