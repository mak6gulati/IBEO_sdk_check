...
#include <ibeo/common/sdk/datablocks/objectassociationlist/ObjectAssociation.hpp>
...
class ObjectAssociationList : public DataContainerBase
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.generalcontainer.objectassociationlist"};
