...
private:
    static constexpr const char* loggerId{"ibeo::common::sdk::ScanImporter2205"};
...
using ScanImporter2205 = Importer<ibeo::common::sdk::Scan, DataTypeId::DataType_Scan2205>;
