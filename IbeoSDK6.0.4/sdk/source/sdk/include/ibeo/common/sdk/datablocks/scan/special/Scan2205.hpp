...
//! \brief Ibeo FUSION SYSTEM/ECU scan data:
//! List of scan points in the new proposed format of class Scan (Generic)
//!
//! Scan data available from Ibeo FUSION SYSTEM and Ibeo AppBase2 (ECU) is sent as data type 0x2205
//! using FUSION SYSTEM version 2.2 and later and Ibeo Laserview 1.6 and later.
...
class Scan2205 : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.scan2205"};
...
public:
    ...
    //! Set whether the scanpoints' segment ID is used as object ID.
