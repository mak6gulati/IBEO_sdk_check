...
class SystemMonitoringCanStatus6700 : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.systemmonitoringcanstatus6700"};
