...
class VehicleState2806 : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.vehiclestate2806"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    VehicleState2806();
    virtual ~VehicleState2806();
...
protected:
    ...
    float m_courseAngle{NaN}; //!< Orientation [0.0001 rad]
