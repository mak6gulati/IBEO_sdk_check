...
class VehicleState2807 : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.vehiclestate2807"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    VehicleState2807();
    virtual ~VehicleState2807();
