...
//! \brief Ibeo FUSION SYSTEM/ECU vehicle state
//!
...
class VehicleState2808 : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"ibeo.sdk.specialcontainer.vehiclestate2808"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    VehicleState2808();
    virtual ~VehicleState2808();
...
protected:
    uint32_t m_microseconds{0}; //!< microseconds since startup.uint32_t m_microseconds{0};
    ...
    float m_vehicleVelocity{NaN}; //!< Current longitudinal velocity of the vehicle | [0.01 m/s]
