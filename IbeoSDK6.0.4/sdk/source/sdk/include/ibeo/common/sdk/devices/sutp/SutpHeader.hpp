...
public:
    ...
    //----------------------------------------
    IBEOSDK_DEPRECATED std::istream& read(std::istream& is)
    {
        deserialize(is);
        return is;
    }
    ...
    //----------------------------------------
    IBEOSDK_DEPRECATED std::ostream& write(std::ostream& os) const
    {
        serialize(os);
        return os;
    }
...
protected:
    static constexpr const char* loggerId = "ibeo::common::sdk::SutpHeader";
