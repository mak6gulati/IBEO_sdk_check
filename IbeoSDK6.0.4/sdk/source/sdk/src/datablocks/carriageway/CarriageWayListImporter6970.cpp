...
Importer<C, DataTypeId::DataType_CarriageWayList6970>::getSerializedSize(const DataContainerBase& c) const
{
    ...
    return CarriageWayListSerializedSize6970::getSerializedSize(*container);
}
...
bool Importer<C, DataTypeId::DataType_CarriageWayList6970>::deserialize(std::istream& is, lanes::CarriageWay& cw)
{
    const int64_t startPos = streamposToInt64(is.tellg());
    ...
    {
        lanes::CarriageWaySegment::Ptr segment = lanes::CarriageWaySegment::create();
        deserialize(is, *segment);
        cw.insert(segment);
    }

    return !is.fail()
           && ((streamposToInt64(is.tellg()) - startPos) == CarriageWayListSerializedSize6970::getSerializedSize(cw));
}

//==============================================================================

bool Importer<C, DataTypeId::DataType_CarriageWayList6970>::deserialize(std::istream& is,
                                                                        lanes::CarriageWaySegment& cws)
{
    const int64_t startPos = streamposToInt64(is.tellg());
    ...
    {
        lanes::Lane::Ptr lane = lanes::Lane::create();
    ...
    return !is.fail()
           && ((streamposToInt64(is.tellg()) - startPos) == CarriageWayListSerializedSize6970::getSerializedSize(cws));
}

//==============================================================================

bool Importer<C, DataTypeId::DataType_CarriageWayList6970>::deserialize(std::istream& is, lanes::Lane& lane)
{
    ...
    {
        lanes::LaneSegment::Ptr seg = lanes::LaneSegment::create();
    ...
    return !is.fail()
           && ((streamposToInt64(is.tellg()) - startPos) == CarriageWayListSerializedSize6970::getSerializedSize(lane));
}

//==============================================================================

bool Importer<C, DataTypeId::DataType_CarriageWayList6970>::deserialize(std::istream& is, lanes::LaneSegment& laneSeg)
{
    const int64_t startPos = streamposToInt64(is.tellg());
    ...
    return !is.fail()
           && ((streamposToInt64(is.tellg()) - startPos)
               == CarriageWayListSerializedSize6970::getSerializedSize(laneSeg));
}

//==============================================================================

bool Importer<C, DataTypeId::DataType_CarriageWayList6970>::deserialize(std::istream& is,
                                                                        lanes::LaneSupportPoint& point)
{
    const int64_t startPos = streamposToInt64(is.tellg());
    ...
    return !is.fail()
           && ((streamposToInt64(is.tellg()) - startPos)
               == CarriageWayListSerializedSize6970::getSerializedSize(point));
}
