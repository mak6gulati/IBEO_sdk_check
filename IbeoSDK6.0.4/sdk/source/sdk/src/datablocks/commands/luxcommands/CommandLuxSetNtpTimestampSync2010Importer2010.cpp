...
#include <ibeo/common/sdk/datablocks/commands/luxcommands/CommandLuxSetNtpTimestampSync2010Importer2010.hpp>

//==============================================================================
namespace {
//==============================================================================
using C  = ibeo::common::sdk::Command2010;
using S  = ibeo::common::sdk::CommandLuxSetNtpTimestampSyncC;
                                                                          ...
                                                                          const IbeoDataHeader& dh) const
{
    ...
    readLE(is, specialType->m_reserved0);
    readLE(is, specialType->m_reserved1);

    uint32_t secs;
    readLE(is, secs);
    uint32_t fracs;
    readLE(is, fracs);
    specialType->m_timestamp.set(secs, fracs);
