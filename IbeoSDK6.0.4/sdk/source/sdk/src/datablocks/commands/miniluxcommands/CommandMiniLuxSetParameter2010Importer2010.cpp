...
#include <ibeo/common/sdk/datablocks/commands/miniluxcommands/CommandMiniLuxSetParameter2010Importer2010.hpp>

//==============================================================================
namespace {
//==============================================================================
using C  = ibeo::common::sdk::Command2010;
using S  = ibeo::common::sdk::CommandMiniLuxSetParameterC;
                                                                          ...
                                                                          const IbeoDataHeader& dh) const
{
    ...
    specialType->m_parameterIndex.readLE(is);
    specialType->m_parameterData.readLE(is);
