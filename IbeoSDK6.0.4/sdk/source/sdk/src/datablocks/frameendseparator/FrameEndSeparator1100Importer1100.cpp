...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_FrameEndSeparator1100>;
...
std::streamsize
Importer<C, DataTypeId::DataType_FrameEndSeparator1100>::getSerializedSize(const DataContainerBase& c) const
{
    try
    {
...
bool Importer<C, DataTypeId::DataType_FrameEndSeparator1100>::deserialize(std::istream& is,
                                                                          DataContainerBase& c,
                                                                          const IbeoDataHeader& dh) const
{
    ...
    readBE(is, container->m_frameId);
    readBE(is, container->m_sizeOfThisFrame);
    readBE(is, container->m_sizeOfNextFrame);
    readBE(is, container->m_creationTime);
