...
std::streamsize Exporter<C, DataTypeId::DataType_LogDebug6430>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Exporter<C, DataTypeId::DataType_LogDebug6430>::serialize(std::ostream& os, const DataContainerBase& c) const
{
    const C* container{nullptr};
    try
    {
