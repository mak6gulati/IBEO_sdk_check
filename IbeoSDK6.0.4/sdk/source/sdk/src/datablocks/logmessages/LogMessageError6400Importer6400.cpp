...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_LogError6400>;
...
std::streamsize Importer<C, DataTypeId::DataType_LogError6400>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_LogError6400>::deserialize(std::istream& is,
                                                                 DataContainerBase& c,
