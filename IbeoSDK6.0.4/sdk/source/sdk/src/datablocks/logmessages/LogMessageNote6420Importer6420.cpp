...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_LogNote6420>;
...
std::streamsize Importer<C, DataTypeId::DataType_LogNote6420>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_LogNote6420>::deserialize(std::istream& is,
                                                                DataContainerBase& c,
