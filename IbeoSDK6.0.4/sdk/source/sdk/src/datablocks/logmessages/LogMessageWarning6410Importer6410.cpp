...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_LogWarning6410>;
...
std::streamsize Importer<C, DataTypeId::DataType_LogWarning6410>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_LogWarning6410>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
