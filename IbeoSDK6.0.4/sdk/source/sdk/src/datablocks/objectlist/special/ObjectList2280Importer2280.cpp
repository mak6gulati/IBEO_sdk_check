...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_ObjectList2280>;
...
std::streamsize Importer<C, DataTypeId::DataType_ObjectList2280>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_ObjectList2280>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
                                                                   const IbeoDataHeader& dh) const
{
    ...
    for (ObjectIn2280& object : container->m_objects)
    {
