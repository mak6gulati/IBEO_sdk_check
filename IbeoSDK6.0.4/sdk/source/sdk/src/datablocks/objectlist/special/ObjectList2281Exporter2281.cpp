...
std::streamsize Exporter<C, DataTypeId::DataType_ObjectList2281>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Exporter<C, DataTypeId::DataType_ObjectList2281>::serialize(std::ostream& os, const DataContainerBase& c) const
{
    const C* container{nullptr};
    try
    {
