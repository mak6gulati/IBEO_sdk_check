...
//==============================================================================
namespace {
using C  = ibeo::common::sdk::ObjectList2281;
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_ObjectList2281>;
...
std::streamsize Importer<C, DataTypeId::DataType_ObjectList2281>::getSerializedSize(const DataContainerBase& c) const
{
    ...
    for (const ObjectIn2281& object : container->m_objects)
    {
...
bool Importer<C, DataTypeId::DataType_ObjectList2281>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
