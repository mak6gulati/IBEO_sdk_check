...
std::streamsize Exporter<C, DataTypeId::DataType_ObjectList2290>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Exporter<C, DataTypeId::DataType_ObjectList2290>::serialize(std::ostream& os, const DataContainerBase& c) const
{
    const C* container{nullptr};
    try
    {
