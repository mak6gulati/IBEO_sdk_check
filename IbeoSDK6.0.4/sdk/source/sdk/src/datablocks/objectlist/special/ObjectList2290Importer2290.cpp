...
//==============================================================================
namespace {
using C  = ibeo::common::sdk::ObjectList2290;
...
std::streamsize Importer<C, DataTypeId::DataType_ObjectList2290>::getSerializedSize(const DataContainerBase& c) const
{
    ...
    for (const ObjectIn2290& obj : container->m_objects)
    {
...
bool Importer<C, DataTypeId::DataType_ObjectList2290>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
                                                                   const IbeoDataHeader& dh) const
{
    ...
    for (ObjectIn2290& obj : container->m_objects)
    {
        obj.deserialize(is);
    }
