...
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_ObjectList2291>;
...
std::streamsize Importer<C, DataTypeId::DataType_ObjectList2291>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_ObjectList2291>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
                                                                   const IbeoDataHeader& dh) const
{
    ...
    for (ObjectIn2291& obj : container->m_objects)
    {
        obj.deserialize(is);
    }
