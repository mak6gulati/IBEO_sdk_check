...
//==============================================================================
namespace {
using C  = ibeo::common::sdk::PointCloud;
using R  = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_PointCloud7510>;
...
std::streamsize Importer<C, DataTypeId::DataType_PointCloud7510>::getSerializedSize(const DataContainerBase& c) const
{
...
bool Importer<C, DataTypeId::DataType_PointCloud7510>::deserialize(std::istream& is,
                                                                   DataContainerBase& c,
                                                                   const IbeoDataHeader& dh) const
{
    ...
    for (std::vector<PointCloudPointIn7510>::iterator pointIter = container->m_points.begin();
