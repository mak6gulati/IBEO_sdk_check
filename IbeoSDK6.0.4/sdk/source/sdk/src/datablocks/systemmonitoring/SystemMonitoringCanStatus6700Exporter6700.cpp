...
std::streamsize
Exporter<C, DataTypeId::DataType_SystemMonitoringCanStatus6700>::getSerializedSize(const DataContainerBase& c) const
{
    try
    {
...
bool Exporter<C, DataTypeId::DataType_SystemMonitoringCanStatus6700>::serialize(std::ostream& os,
                                                                                const DataContainerBase& c) const
{
    ...
    ibeo::common::sdk::writeBE(os, container->m_messageId);
