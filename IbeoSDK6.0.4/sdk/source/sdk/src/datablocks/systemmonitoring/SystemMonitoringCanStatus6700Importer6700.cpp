...
//==============================================================================
namespace {
using C = ibeo::common::sdk::SystemMonitoringCanStatus6700;
using R
    = ibeo::common::sdk::RegisteredImporter<C, ibeo::common::sdk::DataTypeId::DataType_SystemMonitoringCanStatus6700>;
...
std::streamsize
Importer<C, DataTypeId::DataType_SystemMonitoringCanStatus6700>::getSerializedSize(const DataContainerBase& c) const
{
    try
    {
...
bool Importer<C, DataTypeId::DataType_SystemMonitoringCanStatus6700>::deserialize(std::istream& is,
                                                                                  DataContainerBase& c,
                                                                                  const IbeoDataHeader& dh) const
{
    ...
    ibeo::common::sdk::readBE(is, container->m_messageId);
