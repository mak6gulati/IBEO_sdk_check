...
std::streamsize
Exporter<C, DataTypeId::DataType_VehicleStateBasic2807>::getSerializedSize(const DataContainerBase& c) const
{
    try
    {
...
bool Exporter<C, DataTypeId::DataType_VehicleStateBasic2807>::serialize(std::ostream& os,
