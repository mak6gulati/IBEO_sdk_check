...
empty_output_buffer(j_compress_ptr cinfo)
{
    ...
    fprintf(stderr, "jmem_dest: empty_output_buffer: buffer should not ever be full\n");
...
GLOBAL(void)
jpeg_memory_dest(j_compress_ptr cinfo, unsigned char* jfif_buffer, unsigned int buf_size)
{
    mem_dest_ptr dest;
    ...
    { /* first time for this JPEG object? */
        cinfo->dest = (struct jpeg_destination_mgr*)(*cinfo->mem->alloc_small)(
            (j_common_ptr)cinfo, JPOOL_PERMANENT, (size_t)sizeof(mem_destination_mgr));
    }
