...
*/
GLOBAL(void)
jpeg_memory_src(j_decompress_ptr cinfo, const unsigned char* jfif_buffer, unsigned int buf_size)
{
    mem_src_ptr src;
    ...
    if (cinfo->src == NULL)
    {
        ...
        cinfo->src = (struct jpeg_source_mgr*)(*cinfo->mem->alloc_small)(
            (j_common_ptr)cinfo, JPOOL_PERMANENT, ((size_t)sizeof(mem_source_mgr)));
    }
    ...
    src->buffer      = const_cast<JOCTET*>((const JOCTET*)jfif_buffer);
