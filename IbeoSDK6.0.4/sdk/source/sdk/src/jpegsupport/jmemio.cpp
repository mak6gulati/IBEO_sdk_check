...
// Memory objects
#include <ibeo/common/sdk/jpegsupport/jmem_dest.h>
#include <ibeo/common/sdk/jpegsupport/jmem_src.h>

// Include this module's header for prototype checking
#include <ibeo/common/sdk/jpegsupport/jmemio.h>

#include <ibeo/common/logging/logging.hpp>

//==============================================================================
// Handler for error message output. Code copied from jerror.c
// line 97ff.
//------------------------------------------------------------------------------
METHODDEF(void)
logging_output_message(j_common_ptr cinfo)
{
    ...
    LOGWARNING(ibeo::common::logging::LogManager::getInstance().globalLogger(), buffer);
}
//==============================================================================
...
//------------------------------------------------------------------------------
GLOBAL(void)
writeJpegToMemory(unsigned char* img_buf,
                  ...
                  unsigned int* jpeg_comp_size)
{
    ...
    jerr.output_message = logging_output_message;
...
static unsigned char jpeg_odml_dht[0x1a4] = {
    ...
    0xe3, 0xe4, 0xe5, 0xe6, 0xe7, 0xe8, 0xe9, 0xea, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa}; // jpeg_odml_dht

//==============================================================================
// Parse the DHT table.
// This code comes from jpeg6b (jdmarker.c).
static int
jpeg_load_dht(struct jpeg_decompress_struct* info, unsigned char* dht, JHUFF_TBL* ac_tables[], JHUFF_TBL* dc_tables[])
{
...
//------------------------------------------------------------------------------
GLOBAL(int)
readJpegFromMemory(unsigned char* img_buf,
                   unsigned int* width,
                   unsigned int* height,
                   ...
                   const unsigned int jpeg_buffer_size)
{
    ...
    jerr.pub.output_message = logging_output_message;
...
//------------------------------------------------------------------------------
GLOBAL(int)
readJpegFromMemoryPixelFormat(unsigned char* img_buf,
                              unsigned int* width,
                              unsigned int* height,
...
//
GLOBAL(int)
readJpegFromMemory2(unsigned char* img_buf,
                    unsigned int* width,
                    unsigned int* height,
                    const unsigned char* jpeg_buffer,
                    const unsigned int jpeg_buffer_size,
