...
class UserDefinedStructDummy3 : public DeviceStatus6303::UserDefinedStructBase
{
public:
    UserDefinedStructDummy3()
      : DeviceStatus6303::UserDefinedStructBase{DeviceStatus6303::ContentId::Dummy3},
        m_u{TestSupport::getRandValue<uint32_t>()}
    {}

    virtual ~UserDefinedStructDummy3() {}

public:
    //========================================
    virtual bool deserialize(const DeviceStatus6303::ContentDescr& cd)
    {
        if (cd.getContentId() != DeviceStatus6303::ContentId::Dummy3)
        {
            return false;
        }
    ...
    //========================================
    virtual uint8_t getSerializedSize() const { return sizeof(uint32_t); }
