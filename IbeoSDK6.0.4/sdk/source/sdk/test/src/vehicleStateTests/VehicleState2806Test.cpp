...
#include <ibeo/common/sdk/datablocks/vehiclestate/VehicleState2806Importer2806.hpp>
#include <ibeo/common/sdk/datablocks/vehiclestate/VehicleState2806Exporter2806.hpp>

#define BOOST_TEST_MODULE VehicleState2806Test
...
BOOST_AUTO_TEST_SUITE(VehicleStateBasicTestSuite2806)
...
BOOST_FIXTURE_TEST_CASE(createVehicleStateBasic2806, Fixture)
{
    VehicleState2806 vs;
    BOOST_CHECK(true);
}
...
BOOST_FIXTURE_TEST_CASE(isIoVehicleState2806Identity, Fixture)
{
    for (int32_t r = 0; r < nbOfRepeats; ++r)
    {
        const VehicleState2806Exporter2806 exporter;
        VehicleState2806 vsOrig(createVehicleState<VehicleState2806>());
        ...
        VehicleState2806 vsCopy;
        BOOST_CHECK(vsOrig != vsCopy);
        const VehicleState2806Importer2806 importer;
...
BOOST_FIXTURE_TEST_CASE(isIoVehicleState2806Equality, Fixture)
{
    for (int32_t r = 0; r < nbOfRepeats; ++r)
    {
        VehicleState2806 vsOrig, vsCopy;
        BOOST_CHECK(vsOrig == vsCopy);
...
//test operator=
BOOST_FIXTURE_TEST_CASE(isIoVehicleState2806Assignment, Fixture)
{
    for (int32_t r = 0; r < nbOfRepeats; ++r)
    {
        VehicleState2806 vsEmpty, vsOrig, vsCopy;
        BOOST_CHECK(vsOrig == vsCopy);
